...
\cline{3-4}
 & & eeg\_preprocessor & Copied from input \\
\hline
sample\_size & uint16 & eeg\_simulator & 64 samples per message \\
\cline{3-4}
 & & eeg\_preprocessor & Same as input (or reduced if downsampled) \\
\hline
eeg & float32[] & eeg\_simulator & 256 values (4 ch × 64 samples). Simulated alpha (10 Hz), beta (20 Hz), theta (6 Hz) waves + noise (white, drift, 50 Hz powerline, muscle, eye blinks) \\
\cline{3-4}
